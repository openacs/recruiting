...
db_foreach my_completed_interviews {} {
    table::addSortableRow interviews [list "$last_name, $first_name" "$location" "$average_rating" "$should_hire_p" "(<a href=\"view-ratings?[export_vars interview_id]\">view my ratings</a>) (<a href=edit-ratings?[export_vars interview_id]>modify interview</a>)"]
} if_no_rows {
